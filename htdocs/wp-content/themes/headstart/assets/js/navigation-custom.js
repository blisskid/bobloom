jQuery(document).ready(function($){
  ...
  menu_ul.children('.menu-item-has-children').children('a').append('<span class="headstart_menu_switch"><i class="fa fa-caret-right"></i></span>');

  // Touch friendly expanded nav
  $('.headstart_menu_switch').click(function(event){
