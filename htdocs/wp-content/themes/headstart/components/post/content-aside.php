    ...
    <?php if ( '' != get_the_post_thumbnail() ) : ?>
        <div class="index-post-thumbnail">
                <a href="<?php the_permalink(); ?>">
                        <?php the_post_thumbnail( 'headstart-featured-image' ); ?>
                </a>
        </div>
    <?php endif; ?>
...
<?php else : // Set the Featured Image as the Background Image on Archive Pages ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php
            if ( '' != get_the_post_thumbnail() ) { ?> style="background: white url(<?php echo esc_url( the_post_thumbnail_url( 'headstart-featured-image' ) ); ?>);" <?php } ?>>
