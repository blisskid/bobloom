...
?>
    <div class="service-item group">
        ...
        <div class="services-title">
            <a class="services-link" href="<?php the_permalink(); ?>" title="<?php echo esc_attr__( 'Learn more about ', 'headstart' ) . get_the_title(); ?>">
        ...
        <a class="button more-link" role="button" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Learn More &rarr;', 'headstart' ); ?></a>
