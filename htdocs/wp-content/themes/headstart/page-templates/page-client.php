...
<div id="primary" class="content-area archive">
        <main id="main" class="site-main" role="main">
            ...
            <header class="page-header page-header-client">
                <?php echo '<h1 class="page-title"><span class="page-title-pre">' . esc_html__( 'Client Page:', 'headstart' ) . '</span>' . get_the_title() . '</h1>'; ?>
            </header>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					<div>
						...
						<div class="entry-content">
							<?php the_content(); ?>
							<?php wp_link_pages( array( 'before' => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'headstart' ) . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>' ) ); ?>
                                                        <?php headstart_jetpack_sharing(); ?>
                                                </div><!-- .entry-content -->
