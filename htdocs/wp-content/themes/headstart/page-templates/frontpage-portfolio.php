	...
	<div id="primary" class="content-area front-page<?php if (!(have_comments() || comments_open())) : ?> no-comments-area<?php endif; ?>">
        ...
        if( get_theme_mod( 'panel_services' ) ) :
                ...
                if( $query->have_posts() ) { ?>
                    ...
                    if ( $services_query->have_posts() ) { ?>
                        ...
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Pages: Individual Service Pages', 'headstart' );
                ...
                <?php
                    ...
                    $incomplete_sections++;
                    $incomplete_section_ids[] = esc_attr__( 'Page: Services', 'headstart' );
        ...
        if( get_theme_mod( 'panel_clients' ) ) :  
                ...
                if ( $query->have_posts() ) { ?>
                    <section id="clients">    
                        ...
                        if ( $clients_query->have_posts() ) {
                            echo '<h3 class="widget-title front-page-title"><a href="' . esc_url( home_url( "/clients/" )) . '">' . esc_attr__( 'Clients', 'headstart' ) . '</a></h3>';
                            ...
                            $incomplete_sections++;
                            $incomplete_section_ids[] = esc_attr__( 'Pages: Individual Client Pages', 'headstart' );
                        } ?>
                ...
                <?php
                    ...
                    $incomplete_sections++;
                    $incomplete_section_ids[] = esc_attr__( 'Page: Clients', 'headstart' );
                }
        ...
        if( get_theme_mod( 'panel_about' ) ) :  
                    ...
                    <?php 
                        ...
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Page: About', 'headstart' );
                    }
                    // Restore original Post Data
                    wp_reset_postdata();
                    ?>
         ...
         */
                    ...
                    if ( $query->have_posts() ) { ?>
                        <section id="latest-projects" class="group">
                            ...
                            <h2 class="widget-title front-page-title"><a href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>"><?php esc_attr_e( 'Latest Projects', 'headstart' ); ?></a></h2>
                            ...
                            <a class="button more-link" role="button" href="<?php echo esc_url( home_url( '/portfolio/' ) ); ?>"><?php esc_attr_e( 'View Full Portfolio &rarr;', 'headstart' ); ?></a>
                        </section><!-- #latest-work -->

                    <?php
                    } else {
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Jetpack Portfolio Projects', 'headstart' );
                    }
                    // Restore original Post Data
                    wp_reset_postdata();
                    ?>
         ...
         */        
                 ...
                 */
                    ...
                    <?php
                        ...
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Jetpack Testimonials', 'headstart' );
                    }
                    // Restore original Post Data
                    wp_reset_postdata();
         ...
         */     
                    ...
                    if ( $query->have_posts() ) { ?>
                        ...
                        <section id="blog">
                            <h2 class="widget-title front-page-title"><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>"><?php esc_attr_e( 'Latest Articles', 'headstart' ); ?></a></h2>
                            ...
                            <a class="button more-link" role="button" href="<?php echo esc_url( home_url( '/blog/' ) ); ?>"><?php esc_attr_e( 'See More Articles &rarr;', 'headstart' ); ?></a>
                        </section><!-- #blog -->
                    ...
                    <?php
                        ...
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Blog', 'headstart' );
                    }
                    // Restore original Post Data
                    wp_reset_postdata();
        ...
        if( get_theme_mod( 'panel_contact' ) ) :
                    ...
                    <?php
                        ...
                        $incomplete_sections++;
                        $incomplete_section_ids[] = esc_attr__( 'Page: Contact', 'headstart' );
                    }
                    // Restore original Post Data
                    wp_reset_postdata();
        endif;
         ...
         */   
                    if ( $incomplete_sections > 0 && is_user_logged_in() ) : ?>
                        <section id="warnings <?php echo get_theme_mod( 'headstart_show_front_page_notifications', '1' ) == '0' ? 'hide' : '' ?>">
                        
                            <h2 class="page-title"><?php esc_attr__( 'Notifications', 'headstart' ); ?></h2>
                            <div class="entry-content row">
                                <h4><?php printf( esc_html__('You have %s incomplete Front Page sections.', 'headstart' ), $incomplete_sections ); ?></h4>
                                <p><?php esc_html_e( 'Complete the sections listed below OR turn off notifications in the Theme Customizer.', 'headstart' ); ?></p>
                                <ol>
                                <?php
